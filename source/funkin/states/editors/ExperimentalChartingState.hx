...
[] Rid of sections in the frontend
[] Powerful note selection tools
...
typedef ChartNoteData = {
	playerHit:Bool,
	belongingSection:Int,
	data:Array<Dynamic>
}

@:access(flixel.sound.FlxSound._sound)
@:access(openfl.media.Sound.__buffer)
class ExperimentalChartingState extends MusicBeatState
{
	public static var instance:ExperimentalChartingState;
